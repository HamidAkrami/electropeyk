...
class SupportPage extends StatelessWidget {
  ...
  List<ChatBubble> messages = [
    ...
    ChatBubble(
      dateStr: "16:36",
      isUser: false,
      message: "سلام دوست عزیز. چه کمکی از من برمیاد؟",
    ),
    ChatBubble(
      dateStr: "امروز",
      isUser: true,
    ...
    ChatBubble(
      ...
      isUser: true,
      message:
          "پرداخت هام توی قسمت مالی نمایش داده نمیشه  پرداخت هام توی قسمت مالی نمایش داده نمیشه",
    ),
    ChatBubble(
      dateStr: "16:34",
      isUser: false,
      message: "بله در اسرع وقت رسیدگی می شود",
    ),
  ];
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          InkWell(
                            onTap: () {
                              if (inputMessageController.text.length > 0) {
                                // controller.reply(
